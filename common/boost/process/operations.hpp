...
{ 
    ...
    { 
        ...
        if (!envpath) {
            int err_code = errno;
            boost::system::error_code ec(err_code, boost::system::system_category ());
            
            boost::throw_exception(boost::system::system_error(boost::system::errc::make_error_code(boost::system::errc::no_such_file_or_directory), "boost::process::find_executable_in_path: retrieving PATH failed")); 
        }
        path = envpath; 
    } 
    ...
    if (result.empty()) {
        ...
        boost::throw_exception(boost::system::system_error(boost::system::errc::make_error_code(boost::system::errc::no_such_file_or_directory), "boost::process::find_executable_in_path: file not found")); 
    }
    return result; 
} 
